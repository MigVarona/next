...
function Po() {
  return (
    <>
      <div className="flex items-center justify-center h-screen gap-20 mb-10 flex-wrap">
        <Card className="relative max-w-xs overflow-hidden rounded-md justify-center flex align-middle">
          <Card.Container className="flex items-center align-middle">
            <Image
              height={204}
              width={373}
